 ...
 */
fun CityTimezoneEntity.toTimezoneInfo(): TimezoneInfo {
    return TimezoneInfo(
 ...
 */
fun CityTimezoneEntity.toClockTimezone(): ClockTimezone {
...
fun timezoneToCityTimezone(timezone: TimeZone): CityTimezoneEntity {
